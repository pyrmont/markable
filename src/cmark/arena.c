/* NOTE: This is an almost exact copy of cmark-gfm's arena.c. There are two
 * differences. The first is in the included headers. The second is in adding
 * JANET_THREAD_LOCAL to the declaration of A.
 */
...
cmark_mem MARKABLE_ARENA_MEM_ALLOCATOR = {arena_calloc, arena_realloc, arena_free};

cmark_mem *cmark_get_arena_mem_allocator() {
    return &MARKABLE_ARENA_MEM_ALLOCATOR;
}
